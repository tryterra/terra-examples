...
export const dropdownItemStyles = tv({
  base: "group flex items-center gap-4 cursor-pointer select-none py-2 pl-3 pr-3 selected:pr-1 rounded-lg outline outline-0 text-base forced-color-adjust-none no-underline [&[href]]:cursor-pointer [-webkit-tap-highlight-color:transparent]",
  variants: {
    isDisabled: {
      false: "text-main-black",
      true: "text-subtle-text forced-colors:text-[GrayText]",
    },
    isPressed: {
      true: "bg-bg-grey",
    },
    isFocused: {
      true: "bg-emphasis-bg text-main-black forced-colors:bg-[Highlight] forced-colors:text-[HighlightText]",
    },
  },
  compoundVariants: [
    {
