...
const styles = tv({
  ...
  variants: {
    variant: {
      ...
      button:
        "no-underline inline-flex items-center justify-center gap-2 border-2 border-main-black h-12 box-border px-6 py-0 font-sans text-base font-semibold text-center rounded-full cursor-pointer bg-emphasis text-white shadow-button hover:shadow-none hover:-translate-x-[4px] hover:translate-y-[4px] pressed:brightness-[0.8]",
      "button-quiet":
