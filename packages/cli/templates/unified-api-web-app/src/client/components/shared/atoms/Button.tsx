...
const buttonStyles = tv({
  ...
  variants: {
    variant: {
      primary:
        "bg-emphasis text-white rounded-full font-semibold border-2 border-main-black shadow-button enabled:hover:shadow-none enabled:hover:-translate-x-[4px] enabled:hover:translate-y-[4px] pressed:brightness-[0.8]",
      secondary:
        "bg-white text-emphasis rounded-full font-semibold border-2 border-main-black shadow-button enabled:hover:shadow-none enabled:hover:-translate-x-[4px] enabled:hover:translate-y-[4px] pressed:brightness-[0.8]",
      destructive:
        "bg-failure text-white rounded-full font-semibold border-2 border-main-black shadow-button enabled:hover:shadow-none enabled:hover:-translate-x-[4px] enabled:hover:translate-y-[4px] pressed:brightness-[0.8]",
      quiet:
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      isDisabled: true,
      class:
        "bg-transparent border-disabled-grey text-disabled-grey shadow-none",
    },
  ],
});
