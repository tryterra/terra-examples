...
| `ANTHROPIC_API_KEY`     | No       | console.anthropic.com → API Keys              | Enables the AI assistant (also needs the Workers Paid plan)           |
